...
<div class="container">
    <table class="table">
        ...
        <tbody>
        <c:forEach var="client" items="${clientModel.clientList}">
            <tr>
                <td>${client.firstName}</td>
                <td>${client.lastName}</td>
                <td>${client.tele}</td>
                <td>${client.mail}</td>
                <td><a href="EditClient.action?id=${ client.id }" class="btn btn-dark">Edit</a></td>
                <td><a onclick="return confirm('�tes-vous s�r ?')" href="SupprimerClient.action?id=${ client.id }" class="btn btn-dark">Delete</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
